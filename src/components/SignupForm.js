  ...
  const handleSubmit = async () => {
    try {
      ...
      if (response.data.success === true) {
        ...
        NotificationManager.error(response.data.message, "Error", 2000);
      }
    } catch (error) {
      if (error.response && error.response.status === 400) {
        NotificationManager.error(Object.values(error.response.data)[0], "Error", 2000);
      }
      else if (
        error.response &&
            ...
            <div>
              <div class="flex -mx-3">
                <div class="w-1/2 px-3 mb-5">
                  <label for="firstname" class="text-xs font-semibold px-1">
                    First name
                  </label>
                  <div class="flex">
                ...
                <div class="w-1/2 px-3 mb-5">
                  <label for="lastname" class="text-xs font-semibold px-1">
                    Last name
                  </label>
                  <div class="flex">
                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
